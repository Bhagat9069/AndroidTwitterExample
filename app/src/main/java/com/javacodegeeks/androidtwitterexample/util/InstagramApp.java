...
public class InstagramApp {
            ...
            public void run() {
                ...
                try {
                    ...
                    String name = jsonObj.getJSONObject("user").getString(
                            "full_name");
                    String profile_pic = jsonObj.getJSONObject("user").getString(
                            "profile_picture");
                    Log.w("Profile_Image",profile_pic);
                    mSession.storeAccessToken(mAccessToken, id, user, name,profile_pic,"insta");
    ...
    public String getName() {
        ...
        return mSession.getUserProfile();
    }
